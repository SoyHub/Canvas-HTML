// The canvas2 and stage2 are where our sprites are displayed. The canvas2 is defined in
// the index.html file, and the stage2 is an EaselJS object.
var canvas2, stage2, loader;
...
// It creates the various game objects, adds them to the stage2, and kicks off
...
function init2() {
    ...
    // This method creates the various objects that exist in the game, including the 'stage2'
    // which is where the sprite objects are displayed. It's called once, at the start of
    // the app.

    // Get a reference to the canvas2 object, and create the stage2.
    canvas2 = document.getElementById("gameCanvas");
    stage2 = new createjs.Stage("gameCanvas");
    ...
    // Add these objects to the stage2 so they are visible.
    stage2.addChild(sky, grass, scoreText);
    ...
    manifest = [
		{ src: "./500px-brands.svg", id: "dino" },
		{ src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/515428/barrel.png", id: "barrel" },
   	{ src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/515428/fluffy-cloud-small.png", id: "cloud" },
    ];
...
function loadingComplete() {
    ...
    stage2.addChild(dino_walk, dino_stand, dino_lying);
    ...
    //stage2.on("stagemousedown", mouseClicked);
...
function resizeGameWindow() {
    ...
    stage2.setBounds(0, 0, width, height);
